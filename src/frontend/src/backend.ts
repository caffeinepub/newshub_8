...
export class Backend implements backendInterface {
    ...
    async getEditorPicks(): Promise<Array<Article>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEditorPicks();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTrendingArticles(): Promise<Array<Article>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrendingArticles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
